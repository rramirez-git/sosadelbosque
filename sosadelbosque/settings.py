"""
Django settings for sosadelbosque project.
...
ROOT_URLCONF = 'sosadelbosque.urls'
...
WSGI_APPLICATION = 'sosadelbosque.wsgi.application'
...
EMAIL_SETTINGS = MAIN_EMAIL_SETTINGS()
